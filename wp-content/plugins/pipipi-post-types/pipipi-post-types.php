...
acf_add_local_field_group(array(
    ...
    'fields' => array(
        array(
            ...
            'label' => 'Soundcloud Mix API Key',
            'name' => 'soundcloud_mix_key',
            'type' => 'text',
            'instructions' => 'API key of the Soundcloud mix',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        array(
            ...
            'label' => 'Artist Soundcloud Link',
            'name' => 'artist_link',
            'type' => 'url',
            'instructions' => 'URL of artist\'s Soundcloud link',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        array(
            'key' => 'field_5fc57684f7653',
            'label' => 'Artist Soundcloud Account',
            'name' => 'artist_sc_account',
            'type' => 'text',
            'instructions' => 'Artist\'s Soundcloud account name',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        array(
            'key' => 'field_5fcc1ad2108c0',
            'label' => 'Artist Location',
            'name' => 'artist_location',
            'type' => 'text',
            'instructions' => 'Where does the DJ claim residence?',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        array(
            'key' => 'field_5fcc1aec108c1',
            'label' => 'Additional Artist Info',
            'name' => 'additional_info',
            'type' => 'textarea',
            'instructions' => 'Any additional details about the artist can go here, e.g. record label or party series affiliations.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
